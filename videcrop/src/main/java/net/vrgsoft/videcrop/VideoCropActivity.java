...
//        mTvAspect16by9 = findViewById(R.id.tvAspect16by9);
        ...
        square_bg=findViewById(R.id.square);
...
//            String crop = String.format("crop=%d:%d:%d:%d:exact=0,scale=-2:400", cropRect.right, cropRect.bottom, cropRect.left, cropRect.top);
